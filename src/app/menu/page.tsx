...
import { checkedNote, deleteNote } from "@/lib/slices/noteSlice";
...
export default function Page() {
  ...
  return (
    <div className=" absolute h-full w-full bg-[#ffffdd] flex flex-col justify-center items-center gap-3 p-10 sm:max-w-lg left-1/2 -translate-x-1/2">
      <button
        className={btnCSS + " bg-[#ffffaa]"}
